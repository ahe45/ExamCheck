...
import { FormTemplateCodeParamDto, SaveFormTemplateDto, UpdateFormTemplateMetadataDto } from "./form-templates.dto.js";
...
export class FormTemplatesController {
  ...
  listForAdmin() {
    return this.formTemplatesService.listLatest(false);
  }

  @Get()
  listActive() {
    return this.formTemplatesService.listLatest(true);
  }
